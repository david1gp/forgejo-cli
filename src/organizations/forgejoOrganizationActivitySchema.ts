...
const forgejoOrganizationActivitySchema = a.looseObject({
...
export { forgejoOrganizationActivitySchema }
export type ForgejoOrganizationActivity = a.InferOutput<typeof forgejoOrganizationActivitySchema>
